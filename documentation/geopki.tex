...
Using base two, $B_{x}:= \left\lfloor \log_2(\frac{2 a \pi}{u}) \right\rfloor + 1 = 26$ bits for the longitude thus suffice to represent each possible meter value in the worst case.
...
Thus $\left\lfloor\log_2(\frac{b \pi}{u})\right\rfloor + 1 = 25 =: B_{y}$ bits suffice.
