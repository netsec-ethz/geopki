...
-- update neighbor hashes, do this after all nodes have been updated
-- first for all 2D tree neighbors
WITH node_hashes AS (
  SELECT
    nodes.bit_string_51 as bit_string_51,
    nodes.bit_string_15 as bit_string_15,
  ...
  -- conditions on the original table
  WHERE LENGTH(nodes.bit_string_15) = 0
)
UPDATE nodes
