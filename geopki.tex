...
Moreover \texttt{ST\_3DDWithin} does not support polar coordinates and simply treating the polar coordinates as if they were euclidian will cause wrong results.
...
An alternative approach would be to limit a input sphere's radius to a value where the differences between polar and euclidian coordinates are not significant and thus \texttt{ST\_3DDWithin} could be used.
