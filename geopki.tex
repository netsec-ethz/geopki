...
Thus $\left\lceil\log2(C_y)\right\rceil = 25 =: B_{y}$ bits suffice.
...
Alternatively, the first $B_{x} + B_{y}$ steps can be performed by intersecting a circle (at the height of the sphere's center where the radius is maximized) with rectangles (the voxels areas at zero altitude).
