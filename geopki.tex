...
If we did not have to approximate the circle using a polygon it would correspond to intersecting the voxels with a cylinder.
...
Using exclusively polar coordinates it is not possible to represent a sphere and while PostgreSQL's postgis extension has a \texttt{ST\_DistanceSphere} function, it cannot make use of an index.
